    ...
    async prompt(params) {
        ...
        while (true) {
            ...
            switch (message.type) {
                ...
                case "stream_event": {
                    for (const notification of streamEventToAcpNotifications(message, params.sessionId, this.toolUseCache, this.fileContentCache)) {
                ...
                case "assistant": {
                    ...
                    for (const notification of toAcpNotifications(content, message.message.role, params.sessionId, this.toolUseCache, this.fileContentCache)) {
                        await this.client.sessionUpdate(notification);
                    }
                    break;
                }
 ...
 */
export function toAcpNotifications(content, role, sessionId, toolUseCache, fileContentCache) {
...
export function streamEventToAcpNotifications(message, sessionId, toolUseCache, fileContentCache) {
    const event = message.event;
    switch (event.type) {
        case "content_block_start":
            return toAcpNotifications([event.content_block], "assistant", sessionId, toolUseCache, fileContentCache);
        case "content_block_delta":
            return toAcpNotifications([event.delta], "assistant", sessionId, toolUseCache, fileContentCache);
        // No content
        case "message_start":
        case "message_delta":
        case "message_stop":
