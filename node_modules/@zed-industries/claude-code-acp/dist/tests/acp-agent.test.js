...
describe("tool conversions", () => {
    ...
    it("should handle plan entries", () => {
        ...
        expect(toAcpNotifications(received.message.content, received.message.role, "test", {}, {})).toStrictEqual([
            {
                sessionId: "test",
                update: {
                    sessionUpdate: "plan",
...
describe("SDK behavior", () => {
    it.skipIf(!process.env.RUN_INTEGRATION_TESTS)("query has a 'default' model", async () => {
