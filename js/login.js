...
async function login () {
  ...
  try {
    ...
    window.location.href = './V-TRACK/html/index.html';
  } catch (error) {
...
// Function to handle Enter key press and login and redirect to the main page of the application
function handleKeyPress (event) {
  if (event.key === 'Enter') {
    login () || signUp () || sendOTP () || resetPassword ();
  }
}
